...
public class PostObjectSample {
    ...
    // 需要上传的本地文件，确保该文件存在
    private String localFilePath = PathUtil.getClassResources() + Const.FILEPATH_STATIC + Const.FILEPATH_UPLOAD +"example-crop.jpg";
    ...
    private static String key = "20180815/75341097294107.jpg";
    ...
    private void PostObject() throws Exception {
        ...
        String signatureUrl = "http://xiaertest.oss-cn-hangzhou.aliyuncs.com/20180815/75341097294107.jpg?OSSAccessKeyId=LTAIGDEEo84OsWLa&Signature="+signaturecom+"&Expires=1535236105";
