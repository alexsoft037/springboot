...
<#--  xiaoer 2018-09-23 20:48:27-->
            ...
            <div class="layui-input-normal">
                <input type="text"  name="contactId" maxlength="20" lay-verify="required"
                 value="${(model.contactId)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="attachment" maxlength="64" lay-verify="required"
                 value="${(model.attachment)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="contactInfo" maxlength="256" lay-verify="required"
                 value="${(model.contactInfo)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
