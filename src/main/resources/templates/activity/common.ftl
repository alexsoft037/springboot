...
<div class="layui-form-item">${(model.bucket)!""}
    ...
    <div class="layui-input-normal">
        <div cyType="selectTool" cyProps="url:'/getData/getCodeValues?codeName=activityType',search:'true',filter:'demo'" name="activityTypeCode" value="${(model.activityTypeCode)!""}" class="layui-input-inline"></div>
    </div>
</div>
...
<div class="layui-form-item">${(model.bucket)!""}
    ...
    <div class="layui-input-normal">
        <div cyType="selectTool" cyProps="url:'/getData/getCodeValues?codeName=activityStatus',search:'true',filter:'activityStatus'" name="activityStatusCode" value="${(model.activityStatusCode)!""}" class="layui-input-inline"></div>
    </div>
</div>

<div class="layui-form-item">${(model.bucket)!""}
    <label class="layui-form-label"><span class="span_must">*</span>期间开始</label>
    <div class="layui-input-normal">
        <input type="text" name="periodFrom1" id="periodFrom" maxlength="25" placeholder="yyyy-MM-dd HH:mm:ss" lay-verify="required" value="${(model.periodFrom?string["yyyy-MM-dd HH:mm:ss"])!.now?string["yyyy-MM-dd HH:mm:ss"]}" lay-verify="datetime" class="layui-input">
    </div>
</div>

<div class="layui-form-item">${(model.bucket)!""}
    <label class="layui-form-label"><span class="span_must">*</span>期间结束</label>
    <div class="layui-input-normal">
        <input type="text" name="periodTo1" id="periodTo" maxlength="25" placeholder="yyyy-MM-dd HH:mm:ss" lay-verify="required" value="${(model.periodTo?string["yyyy-MM-dd HH:mm:ss"])!""}" lay-verify="datetime" class="layui-input">
    </div>
</div>

<div class="layui-form-item">${(model.bucket)!""}
    <label class="layui-form-label"><span class="span_must">*</span>报名截止</label>
    <div class="layui-input-normal">
        <input type="text" name="registerEnd1" id="registerEnd" maxlength="25" placeholder="yyyy-MM-dd" lay-verify="required" value="${(model.registerEnd?string["yyyy-MM-dd"])!""}" lay-verify="datetime" class="layui-input">
    </div>
</div>

<div class="layui-form-item">${(model.bucket)!""}
    <label class="layui-form-label"><span class="span_must">*</span>联系人姓名</label>
    <div class="layui-input-normal">
        <input type="text" name="contactName" lay-verify="required" value="${(model.contactName)!""}" placeholder="请输入" class="layui-input">
    </div>
</div>
...
<div class="layui-form-item">${(model.bucket)!""}
    ...
    <div class="layui-input-normal">
        <input type="text" name="contactPhone" lay-verify="required" value="${(model.contactPhone)!""}" placeholder="请输入" class="layui-input">
    </div>
</div>
...
<div class="layui-form-item">${(model.bucket)!""}
    ...
    <div class="layui-input-normal">
        <input type="number" min="0" name="integral" lay-verify="required" value="${(model.integral)!""}" placeholder="请输入经验值" class="layui-input">
    </div>
</div>
...
<div class="layui-form-item">${(model.bucket)!""}
    ...
    <div class="layui-input-normal">
        <input type="number" name="numberOfPeople" maxlength="11" lay-verify="required" value="${(model.numberOfPeople)!"0"}" placeholder="请输入" class="layui-input">
    </div>
</div>
...
<div class="layui-form-item">${(model.bucket)!""}
    ...
    <div class="layui-input-normal">
        <input type="number" name="weight" maxlength="11" value="${(model.weight)!"0"}" placeholder="请输入" class="layui-input">
    </div>
</div>

<div class="layui-form-item">${(model.bucket)!""}
    <label class="layui-form-label"><span class="span_must">*</span>热门活动设置</label>
    <div class="layui-input-normal">
        <input type="checkbox" name="featuredYn" title="热门活动设置" value="Y" lay-skin="primary" <#if model?? && model.featuredYn?? && model.featuredYn == 'Y'>checked</#if>>
