...
<div class="layui-form-item">${(model.bucket)!""}
    ...
    <div class="layui-input-normal">
        <input type="text" name="authorName" maxlength="256" lay-verify="required"
               value="${(model.authorName)!""}" placeholder="请输入" class="layui-input">
    </div>
</div>
...
<div class="layui-form-item">${(model.bucket)!""}
    ...
    <div class="layui-input-normal">
        <input type="text" name="createAt1" id="createAt" maxlength="25" placeholder="yyyy-MM-dd HH:mm:ss" lay-verify="required" value="${(model.createAt?string["yyyy-MM-dd HH:mm:ss"])!""}" lay-verify="datetime" class="layui-input">
    </div>
</div>
