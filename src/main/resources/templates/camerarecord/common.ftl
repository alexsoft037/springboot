...
<#--  xiaoer 2018-11-12 07:56:35-->
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="recordUrl" maxlength="1024" lay-verify="required"
                 value="${(model.recordUrl)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="threadId" maxlength="128" lay-verify="required"
                 value="${(model.threadId)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
