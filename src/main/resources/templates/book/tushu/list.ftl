...
<#include "../../resource.ftl"/>
    ...
    <script type="text/javascript" src="/book/tushu/js/list.js"></script>
</head>
<body>
...
<@shiro.hasPermission name="book:save">
    <button class="layui-btn" onclick="addPage('/bookTuShu/add')">
        <i class="fa fa-plus">&nbsp;</i>增加
    </button>
</@shiro.hasPermission>
<@shiro.hasPermission name="book:update">
    <button class="layui-btn" onclick="editPage('bookTable','/bookTuShu/edit')">
        <i class="fa fa-pencil-square-o">&nbsp;</i>修改
    </button>
    <button class="layui-btn layui-btn-green" onclick="updateState('批量启用','bookTable','/bookTuShu/enable')">
        <i class="fa fa-check-square-o">&nbsp;</i>启用
    </button>
    <button class="layui-btn  layui-btn-danger" onclick="updateState('批量禁用','bookTable','/bookTuShu/limit')">
        <i class="fa fa-expeditedssl">&nbsp;</i>禁用
    </button>
</@shiro.hasPermission>
<@shiro.hasPermission name="book:delete">
    <button class="layui-btn layui-btn-delete" onclick="deleteBatch('批量删除','bookTable','/bookTuShu/delete');">
...
<div class="layui-form ">
    <table class="layui-table" id="bookTable" cyType="pageGrid"
           cyProps="url:'/bookTuShu/listData',checkbox:'true',pageColor:'#2991d9'">
        <thead>
        <tr>
            <!--复选框-->
