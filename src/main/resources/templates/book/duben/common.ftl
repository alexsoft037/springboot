<div class="layui-form-item">${(model.bucket)!""}
    ...
    <div class="layui-input-normal">
        <div cyType="selectTool" cyProps="url:'/bookcategory/getCodeValues?upperCode=BCT001',search:'true',filter:'demo'" name="categoryCode" value="${(model.categoryCode)!""}" class="layui-input-inline"></div>
...
<div class="layui-form-item">${(model.bucket)!""}
    ...
    <div class="layui-input-normal">
        <input type="number" name="integral" min="0" lay-verify="required" value="${(model.integral)!""}" placeholder="请输入" class="layui-input">
    </div>
</div>
