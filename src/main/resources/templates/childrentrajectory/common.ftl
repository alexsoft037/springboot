...
<#--  xiaoer 2018-09-03 12:51:23-->
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="latitude" maxlength="64" lay-verify="required"
                 value="${(model.latitude)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="longitude" maxlength="64" lay-verify="required"
                 value="${(model.longitude)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
