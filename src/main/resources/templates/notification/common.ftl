...
<#--  xiaoer 2018-10-16 22:21:41-->
            ...
            <div class="layui-input-normal">
                <input type="text"  name="noteId" maxlength="20" lay-verify="required"
                 value="${(model.noteId)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="content" maxlength="1024" lay-verify="required"
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="readYn" maxlength="1" lay-verify="required"
                 value="${(model.readYn)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="arrivedYn" maxlength="1" lay-verify="required"
                 value="${(model.arrivedYn)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
