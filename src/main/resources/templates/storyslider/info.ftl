...
<div class="layui-field-box">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            <label class="layui-label-left"><span class="label_span">:</span></label>
            <label class="layui-label-right">${(model.bnUrl)!"-"}</label>
        </div>
        <#--<div class="layui-form-item">-->
            <#--<label class="layui-label-left"><span class="label_span">:</span></label>-->
            <#--<label class="layui-label-right">${(model.bnType)!"-"}</label>-->
        <#--</div>-->
        <div class="layui-form-item">
            <label class="layui-label-left"><span class="label_span">:</span></label>
            <label class="layui-label-right">${(model.bnName)!"-"}</label>
        </div>
        <div class="layui-form-item">
            <label class="layui-label-left"><span class="label_span">:</span></label>
            <label class="layui-label-right">${(model.bnText)!"-"}</label>
        </div>
        <div class="layui-form-item">
            <label class="layui-label-left"><span class="label_span">:</span></label>
