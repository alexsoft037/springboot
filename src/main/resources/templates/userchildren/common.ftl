...
<#--  xiaoer 2018-09-03 12:51:23-->
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="name" maxlength="256" lay-verify="required"
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="photo" maxlength="64" lay-verify="required"
                 value="${(model.photo)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="sex" maxlength="1" lay-verify="required"
                 value="${(model.sex)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="height" maxlength="11" lay-verify="required"
                 value="${(model.height)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="birthday" maxlength="20" lay-verify="required"
                 value="${(model.birthday)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
