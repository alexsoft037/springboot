...
<div class="layui-field-box">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">${(model.bucket)!""}
            ...
            <div class="layui-input-normal">
                <div cyType="selectTool" value="${(model.spaceId)!"0"}" cyProps="url:'/space/getCodeValues',search:'true',filter:'demo'" name="spaceId1" class="layui-input-inline"></div>
            </div>
        </div>
        ...
        <#--<div class="layui-form-item">-->
            ...
            <#--<div cyType="selectTool" cyProps="url:'/sys/role/findAll',multiple:'true'"-->
                 <#--value="${(roleIdList)!""}" name="roleIdList1[]" class="layui-input-normal"></div>-->
        <#--</div>-->
        ...
        <div class="page-footer">
            <div class="btn-list">
                <div class="btnlist">
                    <button class="layui-btn" lay-submit="" lay-filter="submit" data-url="/sys/admin/update"><i
