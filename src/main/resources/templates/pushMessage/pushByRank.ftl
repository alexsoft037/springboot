...
<div class="layui-field-box">
    ...
    <form class="layui-form " action="" id="formid">
        ...
        <!--通过url渲染数据-->
        <span class="span_must">*</span>用户等级<br>
        <div id="rank" cyType="radioTool" cyProps="url:'/frontframe/json/rank.json',filter:'sex'"
             name="rank" value="1" class="layui-input-inline"></div>
        <br><br>
