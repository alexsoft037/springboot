...
<#--  xiaoer 2018-08-21 18:17:04-->
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="lessonId" maxlength="11" lay-verify="required"
                 value="${(model.lessonId)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="readCount" maxlength="11" lay-verify="required"
                 value="${(model.readCount)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
