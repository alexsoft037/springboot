...
<head>
    ...
    <script type="text/javascript" src="/aboutus/js/list.js"></script>
</head>
<body>
...
<div class="layui-btn-group">
        ...
        <button class="layui-btn" onclick="addPage('/aboutus/add')">
            <i class="fa fa-plus">&nbsp;</i>增加
        </button>
        </@shiro.hasPermission>
        <@shiro.hasPermission name="helpcenter:update">
        <button class="layui-btn" onclick="editPage('helpCenterTable','/aboutus/edit')">
            <i class="fa fa-pencil-square-o">&nbsp;</i>修改
        </button>
         <button class="layui-btn layui-btn-green" onclick="updateState('批量启用','helpCenterTable','/aboutus/enable')">
             <i class="fa fa-check-square-o">&nbsp;</i>启用
         </button>
        <button class="layui-btn  layui-btn-danger" onclick="updateState('批量禁用','helpCenterTable','/aboutus/limit')">
            <i class="fa fa-expeditedssl">&nbsp;</i>禁用
        </button>
        </@shiro.hasPermission>
        <@shiro.hasPermission name="helpcenter:delete">
         <button class="layui-btn layui-btn-delete"
                 onclick="deleteBatch('批量删除','helpCenterTable','/aboutus/delete');">
...
<div class="layui-form ">
    <table class="layui-table" id="helpCenterTable" cyType="pageGrid"
           cyProps="url:'/aboutus/listData',checkbox:'true',pageColor:'#2991d9'">
        <thead>
        <tr>
            <!--复选框-->
