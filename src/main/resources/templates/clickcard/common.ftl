...
<#--  xiaoer 2018-10-04 01:18:30-->
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="lastClickDt" maxlength="20" lay-verify="required"
                 value="${(model.lastClickDt)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
            ...
            <label class="layui-form-label"><span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="clickCount" maxlength="11" lay-verify="required"
                 value="${(model.clickCount)!""}"  placeholder="请输入"  class="layui-input">
            </div>
        </div>
