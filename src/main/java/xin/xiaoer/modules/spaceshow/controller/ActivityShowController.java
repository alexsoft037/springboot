...
public class ActivityShowController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("activityShow:list")
    public String list() {
        return "activityShow/list";
    }
    ...
    public R listData(@RequestParam Map<String, Object> params){
        //查询列表数据
        params.put("showTypeCode", "SHT002");
     ...
     **/
    @RequestMapping("/add")
    @RequiresPermissions("activityShow:save")
    public String add(Model model){
        model.addAttribute("admin", ShiroUtils.getUserEntity());
        return "activityShow/add";
    }
    ...
    @RequiresPermissions("activityShow:update")
    ...
    @RequiresPermissions("activityShow:info")
    ...
    @RequiresPermissions("activityShow:delete")
