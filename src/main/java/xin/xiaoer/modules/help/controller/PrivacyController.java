...
public class PrivacyController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("privacy:list")
    public String list() {
        return "privacy/list";
    }
     ...
     **/
    @RequestMapping("/add")
    @RequiresPermissions("privacy:save")
    ...
    @RequiresPermissions("privacy:update")
    ...
    @RequiresPermissions("privacy:info")
	...
	public R save(@RequestBody HelpCenter helpCenter){
        ...
        helpCenter.setCategory("PRIVACY");
	...
	@RequiresPermissions("privacy:delete")
