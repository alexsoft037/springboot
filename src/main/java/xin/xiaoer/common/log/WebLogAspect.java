...
import xin.xiaoer.service.SysLogService;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * xin.xiaoer.controller..*.*(..)) || execution(public * xin.xiaoer.modules.*.controller..*.*(..))")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        if(!StringUtil.isEmpty(value)){
            ...
            xin.xiaoer.entity.SysLog sysLog=new xin.xiaoer.entity.SysLog();
            ...
            if (!StringUtility.isEmpty(params) && params.length() > 256){
                sysLog.setParams(params.substring(0, 256));
            } else {
