...
public class Pcre {
  ...
  public static ArrayList<String> preg_match_all(String pattern, String subject) {
    Pattern p = Pcre.compile(pattern);
    return preg_match_all(p, subject);
  }

  public static ArrayList<String> preg_match_all(Pattern p, String subject) {
    Matcher m = p.matcher(subject); // get a matcher object
