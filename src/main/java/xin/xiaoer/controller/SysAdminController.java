...
public class SysAdminController extends AbstractController {
	...
	public R listData(@RequestParam Map<String, Object> params){
		...
		List<SysUser> userList = sysUserService.queryAdminList(query);
		...
		int total = sysUserService.queryAdminTotal(query);
	...
	public R save(@RequestBody Map<String, Object> params){
		...
		user.setSpaceId(Integer.parseInt(spaceId));
		...
		user.setStatus(1);
		user.setUserClassCode(SysUser.ADMIN);
